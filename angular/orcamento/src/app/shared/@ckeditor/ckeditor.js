    ...
    return (function (t) {
      ...
      function (t, e, n) {
        ...
        var Jt = function (t) {
          ...
          Zt = {};
        (Zt['[object Float32Array]'] = Zt['[object Float64Array]'] = Zt['[object Int8Array]'] = Zt[
          '[object Int16Array]'
        ] = Zt['[object Int32Array]'] = Zt['[object Uint8Array]'] = Zt['[object Uint8ClampedArray]'] = Zt[
          '[object Uint16Array]'
        ] = Zt['[object Uint32Array]'] = !0),
          (Zt['[object Arguments]'] = Zt['[object Array]'] = Zt['[object ArrayBuffer]'] = Zt['[object Boolean]'] = Zt[
            '[object DataView]'
          ] = Zt['[object Date]'] = Zt['[object Error]'] = Zt['[object Function]'] = Zt['[object Map]'] = Zt[
            '[object Number]'
          ] = Zt['[object Object]'] = Zt['[object RegExp]'] = Zt['[object Set]'] = Zt['[object String]'] = Zt[
            '[object WeakMap]'
          ] = !1);
        var Xt = function (t) {
        ...
        var En = function (t) {
          ...
          zn = '[object Object]',
          Bn = {};
        (Bn[Ln] = Bn['[object Array]'] = Bn['[object ArrayBuffer]'] = Bn['[object DataView]'] = Bn[
          '[object Boolean]'
        ] = Bn['[object Date]'] = Bn['[object Float32Array]'] = Bn['[object Float64Array]'] = Bn[
          '[object Int8Array]'
        ] = Bn['[object Int16Array]'] = Bn['[object Int32Array]'] = Bn['[object Map]'] = Bn['[object Number]'] = Bn[
          zn
        ] = Bn['[object RegExp]'] = Bn['[object Set]'] = Bn['[object String]'] = Bn['[object Symbol]'] = Bn[
          '[object Uint8Array]'
        ] = Bn['[object Uint8ClampedArray]'] = Bn['[object Uint16Array]'] = Bn['[object Uint32Array]'] = !0),
        ...
        class uo extends ki {
          ...
          _insertChild(t, e) {
            if (e && (e instanceof hi || Array.from(e).length > 0))
        ...
        var gs = function (t, e, n) {
          ...
          function b() {
            ...
            if (((i = arguments), (o = this), (c = t), n)) {
              ...
              if (u) return clearTimeout(a), (a = setTimeout(g, e)), f(c);
            }
          ...
          return (
            ...
            B(n) &&
              ((d = !!n.leading),
              (r = (u = 'maxWait' in n) ? fs(us(n.maxWait) || 0, e) : r),
        ...
        class fa extends la {
          elementToElement(t) {
            return this.add(
              (function (t) {
                return (
                  ((t = ha(t)).view = ga(t.view, 'container')),
                  e => {
                    e.on(
                      'insert:' + t.model,
                      (function (t) {
        ...
        class ka extends la {
          ...
          attributeToAttribute(t) {
            return this.add(
              (function (t) {
                let e = null;
                ('string' == typeof (t = ha(t)).view || t.view.key) &&
                  (e = (function (t) {
        ...
        class hc extends Ja {
          ...
          static fromJSON(t, e) {
            return new hc($s.fromJSON(t.position, e), t.oldName, t.newName, t.baseVersion);
          }
        ...
        class bc {
          ...
          rename(t, e) {
            ...
            const n = t.root.document ? t.root.document.version : null,
              i = new hc($s._createBefore(t), t.name, e, n);
          ...
          return t.isCollapsed
            ...
            : (function (t, e) {
                ...
                if (c || l) {
                  ...
                  let d = n,
                    u = i;
                  return o && (d = $s._createBefore(Gc(s, e))), r && (u = $s._createAfter(Gc(a, e))), new Gs(d, u);
                }
                return null;
              })(t, e);
        }
        ...
        function ll(t) {
          const { view: e, element: n, text: i, isDirectHost: o = !0 } = t,
            r = e.document;
          cl.has(r) || (cl.set(r, new Map()), r.registerPostFixer(t => ul(r, t))),
            cl.get(r).set(n, {
              text: i,
              isDirectHost: o,
            }),
        ...
        function ul(t, e) {
          const n = cl.get(t);
          let i = !1;
          for (const [t, o] of n) hl(e, t, o) && (i = !0);
          return i;
        }
        ...
        class Bl extends zl {
          ...
          render() {
            ...
            t.change(n => {
              ...
              n.setAttribute('aria-label', e('bo', [this.name]), i);
            });
          }
        }
        ...
        class fd extends ed {
          constructor(t, e) {
            super(t), (this._buffer = new hd(t.model, e)), (this._batches = new WeakSet());
          }
        ...
        class yd extends ed {
          constructor(t, e) {
            super(t), (this.direction = e), (this._buffer = new hd(t.model, t.config.get('typing.undoStep')));
          }
        ...
        Sd(ac, ac, (t, e, n) => {
          ...
          Sd(lc, lc, (t, e, n) => {
            ...
            return (
              null !== u &&
                s &&
                ((u.start = u.start._getCombined(e.sourcePosition, e.getMovedRangeStart())),
          ...
          Sd(hc, dc, (t, e) => ((t.position = t.position._getTransformedByInsertOperation(e)), [t])),
          Sd(hc, mc, (t, e) =>
          ...
          Sd(hc, lc, (t, e) => ((t.position = t.position._getTransformedByMoveOperation(e)), [t])),
          Sd(hc, hc, (t, e, n) => {
        ...
        class Gd extends Kl {
          init() {
            ...
            this._addButton('undo', n('co'), 'CTRL+Z', i), this._addButton('redo', n('cp'), 'CTRL+Y', o);
          }
        ...
        ci(Xd, Fi);
        const tu = 'ckCsrfToken',
          eu = 40,
          nu = 'abcdefghijklmnopqrstuvwxyz0123456789';
        ...
        class ou extends Kl {
          ...
          init() {
            ...
            t && (this.editor.plugins.get(Zd).createUploadAdapter = e => new ru(e, t, this.editor.t));
          }
        }
        ...
        class ru {
          ...
          _sendRequest(t) {
            ...
            e.append('upload', t), e.append('ckCsrfToken', iu()), this.xhr.send(e);
          }
        }
            ...
            e instanceof RegExp ? (i = e) : (r = e),
              ...
              t.model.document.on('change', (e, n) => {
                ...
                const c = i.focus.parent,
                  ...
                  d = r(l),
                  u = cu(c, d.format, t.model),
                  h = cu(c, d.remove, t.model);
                u.length &&
                  h.length &&
                  t.model.enqueueChange(t => {
        ...
        class hu extends Kl {
          init() {
            const t = this.editor;
            t.model.schema.extend('$text', { allowAttributes: uu }),
              t.model.schema.setAttributeProperties(uu, {
                isFormatting: !0,
                copyOnEnter: !0,
              }),
              ...
              t.commands.add(uu, new du(t, uu)),
              t.keystrokes.set('CTRL+B', uu);
          }
        }
        ...
        class gu extends Kl {
          init() {
            const t = this.editor,
              e = t.t;
            t.ui.componentFactory.add(mu, n => {
              const i = t.commands.get(mu),
                o = new Wd(n);
              return (
                o.set({
                  label: e('d'),
                ...
                this.listenTo(o, 'execute', () => t.execute(mu)),
                o
              );
            });
          }
        ...
        class bu extends Kl {
          init() {
            const t = this.editor;
            t.model.schema.extend('$text', { allowAttributes: pu }),
              ...
              t.commands.add(pu, new du(t, pu)),
              t.keystrokes.set('CTRL+I', pu);
          }
        }
        ...
        class _u extends Kl {
          init() {
            const t = this.editor,
              e = t.t;
            t.ui.componentFactory.add(ku, n => {
              const i = t.commands.get(ku),
                o = new Wd(n);
              return (
                o.set({
                  label: e('e'),
                ...
                o.bind('isOn', 'isEnabled').to(i, 'value', 'isEnabled'),
                this.listenTo(o, 'execute', () => t.execute(ku)),
                o
              );
            });
          }
        ...
        class yu extends ed {
          ...
          execute(t = {}) {
            ...
            e.change(t => {
              if (r) {
                const e = o.filter(t => xu(t) || Tu(n, t));
                this._applyQuote(t, e);
              } else this._removeQuote(t, o.filter(xu));
            });
          }

          _getValue() {
            const t = vu(this.editor.model.document.selection.getTopMostBlocks());
            return !(!t || !xu(t));
          }
        ...
        class Cu extends Kl {
          init() {
            const t = this.editor,
              e = t.model.schema;
            t.commands.add('blockQuote', new yu(t)),
          ...
          init() {
            ...
            e.add('ckfinder', e => {
              const i = t.commands.get('ckfinder'),
                o = new Wd(e);
              return (
                o.set({ label: n('g'), icon: Mu, tooltip: !0 }),
                  ...
                  e.on('file:choose:resizedImage', e => {
                    ...
                    if (n) Ou(t, [n]);
                      ...
                      const e = t.plugins.get('Notification'),
                        n = t.locale.t;
                      e.showWarning(n('az'), { title: n('ba'), namespace: 'ckfinder' });
                    }
                  });
              }),
              window.CKFinder[e](n);
        ...
        function Ou(t, e) {
          if (t.commands.get('imageUpload').isEnabled) t.execute('imageInsert', { source: e });
            ...
            const e = t.plugins.get('Notification'),
              n = t.locale.t;
            e.showWarning(n('bb'), { title: n('bc'), namespace: 'ckfinder' });
          }
        }
        ...
        class Ru extends Kl {
          ...
          init() {
            const t = this.editor;
            t.commands.add('ckfinder', new Nu(t));
          }
        }

        const Du = /^data:(\S*?);base64,/;
        ...
        ci(Lu, ei);
        const ju = { refreshInterval: 36e5, autoRefresh: !0 };
        ...
        class Vu {
          constructor(t, e = ju) {
            ...
            this.set('value', e.initValue),
              ...
              (this._options = Object.assign({}, ju, e));
          }

          static create(t, e = ju) {
            return new Vu(t, e).init();
          }
        ...
        class Bu extends Kl {
          ...
          init() {
            ...
            if (this.tokenUrl) return (this.token = new Bu.Token(this.tokenUrl)), this.token.init();
            this.token = null;
          }
        }
        ...
        class Fu extends Kl {
          ...
          init() {
            const t = this.editor,
              ...
              i = e.uploadUrl;
            n &&
              ((this._uploadGateway = new Fu._UploadGateway(n, i)),
              (t.plugins.get(Zd).createUploadAdapter = t => new Uu(this._uploadGateway, t)));
          }
        }
        ...
        Fu._UploadGateway = class {
          ...
          upload(t) {
            return new Lu(t, this._token, this._apiAddress);
          }
        };
        ...
        class Wu {
          ...
          add(t, e) {
            ...
            const o = n[0];
            i === o || Yu(i, o) || this.fire('change:top', { oldDescriptor: i, newDescriptor: o, writer: e });
          }
        ...
        function Yu(t, e) {
          return t && e && t.priority == e.priority && Gu(t.classes) == Gu(e.classes);
        }

        function $u(t, e) {
          return t.priority > e.priority || (!(t.priority < e.priority) && Gu(t.classes) > Gu(e.classes));
        }
              ...
              (function (t, e) {
                const n = e.createUIElement('div', { class: 'ck ck-widget__selection-handler' }, function (t) {
                  const e = this.toDomElement(t),
                    n = new Hd();
                  return n.set('content', Qu), n.render(), e.appendChild(n.element), e;
                });
        ...
        function oh(t) {
          ...
          return e &&
            (function (t) {
              return !!t.getCustomProperty('image') && Zu(t);
            })(e)
            ? e
            : null;
        }
        ...
        class ch extends ed {
          refresh() {
            this.isEnabled = ah(this.editor.model);
          }
        ...
        class fh extends Kl {
          ...
          _onMousedown(t, e) {
            ...
            if (!Zu(r) && !(r = r.findAncestor(Zu))) return;
          ...
          _clearPreviouslySelectedWidgets(t) {
            for (const e of this._previouslySelected) t.removeClass(Ju, e);
        ...
        class gh extends ed {
          refresh() {
            ...
            (this.isEnabled = rh(t)),
              rh(t) && t.hasAttribute('alt') ? (this.value = t.getAttribute('alt')) : (this.value = !1);
          }
        ...
        class ph extends Kl {
          init() {
            this.editor.commands.add('imageTextAlternative', new gh(this.editor));
          }
        }

        function bh({ emitter: t, activator: e, callback: n, contextElements: i }) {
        ...
        class xh extends Dl {
          constructor(t) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.saveButtonView = this._createButton(e('bu'), vh, 'ck-button-save')),
              (this.saveButtonView.type = 'submit'),
              (this.cancelButtonView = this._createButton(e('bv'), yh, 'ck-button-cancel', 'cancel')),
          ...
          _createLabeledInputView() {
            const t = this.locale.t,
              e = new wh(this.locale, kh);
            return (e.label = t('bw')), (e.inputView.placeholder = t('bw')), e;
          }
        }

        function Ah({ element: t, target: e, positions: n, limiter: i, fitInViewport: o }) {
          W(e) && (e = e()), W(i) && (i = i());
          const r = (function (t) {
              ...
              (function (t, e, n, i, o) {
                ...
                return (
                  t.some(t => {
                    ...
                    return (
                      o && (f = o.getIntersectionArea(u)),
                      o && !i ? f > c && m() : !o && i ? h > a && m() : f > c && h >= a ? m() : f >= c && h > a && m(),
                      h === l
                    );
                  }),
                  r ? [s, r] : null
                );
              })(n, a, s, t, e) || Th(n[0], a, s);
          } else [l, c] = Th(n[0], a, s);
          let { left: d, top: u } = Ch(c);
          if (r) {
            const t = Ch(new As(r)),
              e = ys(r);
            ...
            this.set('top', 0),
              ...
              this.setTemplate({
                ...
                attributes: {
                  ...
                  style: { top: e.to('top', Ph), left: e.to('left', Ph) },
                },
                children: this.content,
              });
          }
        ...
        function Eh(t) {
          return Wn(t) ? t : vs(t) ? t.commonAncestorContainer : 'function' == typeof t ? Eh(t()) : null;
        }

        function Ih(t, e) {
          return t.top - e.height - Mh.arrowVerticalOffset;
        }

        function Nh(t) {
          return t.bottom + Mh.arrowVerticalOffset;
        }

        (Mh.arrowHorizontalOffset = 25),
          (Mh.arrowVerticalOffset = 10),
          (Mh._getOptimalPosition = Ah),
          (Mh.defaultPositions = {
            northArrowSouth: (t, e) => ({ top: Ih(t, e), left: t.left + t.width / 2 - e.width / 2, name: 'arrow_s' }),
            northArrowSouthEast: (t, e) => ({
              top: Ih(t, e),
              left: t.left + t.width / 2 - e.width + Mh.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northArrowSouthWest: (t, e) => ({
              top: Ih(t, e),
              left: t.left + t.width / 2 - Mh.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            northWestArrowSouth: (t, e) => ({ top: Ih(t, e), left: t.left - e.width / 2, name: 'arrow_s' }),
            northWestArrowSouthWest: (t, e) => ({
              top: Ih(t, e),
              left: t.left - Mh.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            northWestArrowSouthEast: (t, e) => ({
              top: Ih(t, e),
              left: t.left - e.width + Mh.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northEastArrowSouth: (t, e) => ({ top: Ih(t, e), left: t.right - e.width / 2, name: 'arrow_s' }),
            northEastArrowSouthEast: (t, e) => ({
              top: Ih(t, e),
              left: t.right - e.width + Mh.arrowHorizontalOffset,
              name: 'arrow_se',
            }),
            northEastArrowSouthWest: (t, e) => ({
              top: Ih(t, e),
              left: t.right - Mh.arrowHorizontalOffset,
              name: 'arrow_sw',
            }),
            southArrowNorth: (t, e) => ({ top: Nh(t), left: t.left + t.width / 2 - e.width / 2, name: 'arrow_n' }),
            ...
            southWestArrowNorth: (t, e) => ({ top: Nh(t), left: t.left - e.width / 2, name: 'arrow_n' }),
            ...
            southEastArrowNorth: (t, e) => ({ top: Nh(t), left: t.right - e.width / 2, name: 'arrow_n' }),
        ...
        class Lh extends Kl {
          ...
          _createRotatorView() {
            const t = new jh(this.editor.locale),
          ...
          _createFakePanelsView() {
            const t = new Vh(this.editor.locale, this.view);
            return (
        ...
        class jh extends Dl {
          constructor(t) {
            ...
            this.set('isNavigationVisible', !0),
              (this.focusTracker = new sl()),
              (this.buttonPrevView = this._createButtonView(e('bs'), Oh)),
              (this.buttonNextView = this._createButtonView(e('bt'), Rh)),
              (this.content = this.createCollection()),
              this.setTemplate({
                tag: 'div',
                ...
                oh(e.selection)
                  ? this._isVisible &&
                    (function (t) {
                      ...
                      if (oh(t.editing.view.document.selection)) {
                        const n = Bh(t);
                        e.updatePosition(n);
                      }
                    })(t)
        ...
        var Kh = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 250"><rect rx="4"/></svg>';
        n(52), n(54), n(56);

        class Jh extends Kl {
          constructor(t) {
            super(t), (this.placeholder = 'data:image/svg+xml;utf8,' + encodeURIComponent(Kh));
          }
          ...
          uploadStatusChange(t, e, n) {
            ...
            const s = i.plugins.get(Zd),
              ...
              d = n.writer;
            if ('reading' == a) return Zh(l, d), void Xh(c, l, d);
            if ('uploading' == a) {
            ...
            n.extend('image', { allowAttributes: ['uploadId', 'uploadStatus'] }),
              ...
              this.listenTo(t.editing.view.document, 'clipboardInput', (e, n) => {
                if (
                  ...
                  return;
                const i = Array.from(n.dataTransfer.files).filter(t => !!t && $h(t)),
        ...
        class df extends ed {
          refresh() {
            const t = this.editor.model,
              e = vu(t.document.selection.getSelectedBlocks());
            (this.value = !!e && e.is('paragraph')), (this.isEnabled = !!e && uf(e, t.schema));
          }
          ...
          execute(t = {}) {
            ...
            e.change(i => {
              ...
              for (const t of o) !t.is('paragraph') && uf(t, e.schema) && i.rename(t, 'paragraph');
            });
          }
        }
          ...
          init() {
            ...
            t.commands.add('paragraph', new df(t)),
              ...
              t.conversion.for('upcast').elementToElement({
                model: (t, e) =>
                  hf.paragraphLikeElements.has(t.name) ? (t.isEmpty ? null : e.createElement('paragraph')) : null,
        ...
        hf.paragraphLikeElements = new Set([
          'blockquote',
          'dd',
          'div',
          'dt',
        ...
        class gf extends ed {
          ...
          refresh() {
            const t = vu(this.editor.model.document.selection.getSelectedBlocks());
          ...
          init() {
            ...
            const s = (function (t, e) {
              return n => {
                ...
                return n.setCustomProperty('imageCaption', !0, i), ll({ view: t, element: i, text: e }), eh(i, n);
              };
            })(e, r('r'));
        ...
        class Qf extends Kl {
          ...
          get localizedDefaultStylesTitles() {
            ...
            return {
              'Full size image': t('s'),
              'Side image': t('t'),
              'Left aligned image': t('u'),
              'Centered image': t('v'),
              'Right aligned image': t('w'),
            };
          }
        ...
        class Kf extends Kl {
          ...
          register(t, { ariaLabel: e, items: n, getRelatedElement: i, balloonClassName: o = 'ck-toolbar-container' }) {
            const r = this.editor,
              s = r.t,
              a = new $l(r.locale);
            if (((a.ariaLabel = e || s('ay')), this._toolbarDefinitions.has(t)))
        ...
        var am = function (t) {
          ...
          fm = '[\\ud800-\\udbff][\\udc00-\\udfff]',
          mm = '(?:' + lm + '|' + dm + ')' + '?',
          gm = '[\\ufe0e\\ufe0f]?' + mm + ('(?:\\u200d(?:' + [um, hm, fm].join('|') + ')[\\ufe0e\\ufe0f]?' + mm + ')*'),
          pm = '(?:' + [um + lm + '?', lm, hm, fm, cm].join('|') + ')',
        ...
        class Hm extends Kl {
          ...
          init() {
            ...
            const n = (function (t, e) {
              const n = { 'Open in a new tab': t('ct'), Downloadable: t('cu') };
        ...
        class Wm extends Dl {
          constructor(t, e = []) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.saveButtonView = this._createButton(n('bu'), vh, 'ck-button-save')),
              (this.saveButtonView.type = 'submit'),
              (this.cancelButtonView = this._createButton(n('bv'), yh, 'ck-button-cancel', 'cancel')),
          ...
          _createUrlInput() {
            const t = this.locale.t,
              e = new wh(this.locale, kh);
            return (e.label = t('cz')), (e.inputView.placeholder = 'https://example.com'), e;
          }
        ...
        class Gm extends Dl {
          constructor(t) {
            ...
            (this.focusTracker = new sl()),
              ...
              (this.unlinkButtonView = this._createButton(e('cv'), Ym, 'unlink')),
              (this.editButtonView = this._createButton(e('cw'), $m, 'edit')),
              this.set('href'),
              (this._focusables = new gl()),
              (this._focusCycler = new ql({
                focusables: this._focusables,
          ...
          _createPreviewButton() {
            ...
            return (
              ...
              t.bind('label').to(this, 'href', t => t || n('cy')),
        ...
        class Jm extends Kl {
          ...
          init() {
            ...
            t.editing.view.addObserver(qm),
              ...
              (this._balloon = t.plugins.get(Lh)),
        ...
        class yg extends Kl {
          ...
          init() {
            ...
            t.model.document.registerPostFixer(e =>
              ...
              n.downcastDispatcher.on('attribute:listType:listItem', ug, { priority: 'high' }),
              n.downcastDispatcher.on('attribute:listType:listItem', hg, { priority: 'low' }),
        ...
        class Cg extends Kl {
          init() {
            const t = this.editor.t;
            cg(this.editor, 'numberedList', t('k'), Ag), cg(this.editor, 'bulletedList', t('l'), Tg);
          }
        }
              ...
              i.for('editingDowncast').elementToElement({
                ...
                view: (t, e) => {
                  ...
                  return (function (t, e, n) {
                    return e.setCustomProperty('media', !0, t), Xu(t, e, { label: n });
                  })(Sg(e, r, i, { renderForEditingView: !0 }), e, n('m'));
                },
              }),
        ...
        class Bg extends Dl {
          ...
          _createUrlInput() {
            const t = this.locale.t,
              ...
              n = e.inputView;
            return (
              (this._urlInputViewInfoDefault = t('cq')),
              (this._urlInputViewInfoTip = t('cr')),
              (e.label = t('cs')),
          ...
          init() {
            ...
            (this.form = new Bg(
              (function (t, e) {
                return [
                  e => {
                    if (!e.url.length) return t('o');
                  },
                  n => {
                    if (!e.hasMedia(n.url)) return t('p');
                  },
                ];
              })(t.t, n),
              t.locale
        ...
        function cp(t) {
          return !!t.getCustomProperty('table') && Zu(t);
        }
          ...
          return e =>
            e.on('insert:table', (e, n, i) => {
              ...
              i.writer.insert(i.writer.createPositionAt(s, 0), a),
                r &&
                  (c = (function (t, e) {
                    return e.setCustomProperty('table', !0, t), Xu(t, e, { hasSelectionHandler: !0 });
                  })(s, i.writer));
              const l = new ap(o),
                d = {
              ...
              for (const e of l) {
                const { row: n, cell: r } = e,
                  s = yp(vp(n, d), a, i),
                  c = o.getChild(n),
                  l = u.get(n) || kp(c, n, s, i);
                u.set(n, l), i.consumable.consume(r, 'insert'), wp(e, d, i.writer.createPositionAt(l, 'end'), i, t);
              }
        ...
        function pp(t, e, n, i) {
          ...
          let s;
          if (i) {
            (s = eh(o.createEditableElement(e, r.getAttributes()), o)),
        ...
        function wp(t, e, n, i, o) {
          const r = o && o.asWidget,
            s = _p(t, e),
            a = r ? eh(i.writer.createEditableElement(s), i.writer) : i.writer.createContainerElement(s),
            c = t.cell,
            l = c.getChild(0),
          ...
          execute() {
            ...
            t.change(t => {
              ...
              r
                ...
                .forEach(({ column: t, cell: e, rowspan: n }) =>
                  s.set(t, {
                    cell: e,
                    rowspanToSet: n - 1,
                  })
        ...
        function Lp(t, e, n) {
          ...
          const l = o.getChildIndex(i),
            d = l + r,
            u = [...new ap(o, { startRow: l, endRow: d, includeSpanned: !0 })];
          let h;
          for (const { row: e, column: i, cell: r, cellIndex: a } of u)
            if ((r === t && void 0 === h && (h = i), void 0 !== h && h === i && e === d)) {
              ...
              if (s > 1) {
                ...
                for (const { column: t, row: e, cellIndex: s } of i) {
                  if (e >= r + l && t === d && (e + r + l) % c == 0) {
                    Bp(1, n, n.createPositionAt(o.getChild(e), s), u);
                  }
                }
              }
              if (s < e) {
          ...
          init() {
            ...
            t.ui.componentFactory.add('insertTable', n => {
              const i = t.commands.get('insertTable'),
                o = Sf(n);
              o.bind('isEnabled').to(i), o.buttonView.set({ icon: nb, label: e('z'), tooltip: !0 });
              const r = new tb(n);
              return (
              ...
              t.ui.componentFactory.add('tableColumn', t => {
                const n = [
                  ...
                  {
                    type: 'button',
                    model: { commandName: 'insertTableColumnLeft', label: e('ab') },
                  },
                  { type: 'button', model: { commandName: 'insertTableColumnRight', label: e('ac') } },
                  {
                    type: 'button',
                    model: { commandName: 'removeTableColumn', label: e('ad') },
                  },
                ];
                return this._prepareDropdown(e('ae'), ib, n, t);
              }),
              t.ui.componentFactory.add('tableRow', t => {
                ...
                return this._prepareDropdown(e('aj'), ob, n, t);
              }),
              t.ui.componentFactory.add('mergeTableCells', t => {
                const n = [
                  { type: 'button', model: { commandName: 'mergeTableCellUp', label: e('ak') } },
                  {
                    type: 'button',
                    model: { commandName: 'mergeTableCellRight', label: e('al') },
                  },
                  { type: 'button', model: { commandName: 'mergeTableCellDown', label: e('am') } },
                  {
                    type: 'button',
                    model: { commandName: 'mergeTableCellLeft', label: e('an') },
                  },
                  { type: 'separator' },
                  {
                    type: 'button',
                ...
                return this._prepareDropdown(e('aq'), rb, n, t);
              });
          }
        ...
        n(89);
        const cb = ['left', 'right', 'center', 'justify'];
        ...
        class hb extends ed {
          refresh() {
            const t = this.editor.locale,
              e = vu(this.editor.model.document.selection.getSelectedBlocks());
          ...
          execute(t = {}) {
            ...
            i.change(t => {
              ...
              db(r, n) || i === r || !r
                ? (function (t, e) {
                    for (const n of t) e.removeAttribute(ub, n);
                  })(e, t)
                : (function (t, e, n) {
                    for (const i of t) e.setAttribute(ub, n, i);
                  })(e, t, r);
            });
          }

          _canBeAligned(t) {
            return this.editor.model.schema.checkAttribute(t, ub);
          }
        }

        class fb extends Kl {
          constructor(t) {
            super(t), t.config.define('alignment', { options: [...cb] });
          }
          ...
          init() {
            const t = this.editor,
              e = t.locale,
              n = t.model.schema,
              i = t.config.get('alignment.options').filter(lb);
            ...
            const o = (function (t) {
              ...
              for (const n of t) e.view[n] = { key: 'style', value: { 'text-align': n } };
              return e;
            })(i.filter(t => !db(t, e)));
            t.conversion.attributeToAttribute(o), t.commands.add('alignment', new hb(t));
          }
        }
        ...
        class bb extends Kl {
          ...
          get localizedOptionTitles() {
            const t = this.editor.t;
            return { left: t('ar'), right: t('as'), center: t('at'), justify: t('au') };
          }
          ...
          init() {
            ...
            i.filter(lb).forEach(t => this._addButton(t)),
              e.add('alignment', t => {
                const o = Sf(t),
                ...
                !(function (t, e) {
                  const n = t.locale,
                    i = n.t,
                    o = (t.toolbarView = new $l(n));
                  o.set('ariaLabel', i('bp')),
                  ...
                  (o.toolbarView.isVertical = !0),
                  (o.toolbarView.ariaLabel = n('aw')),
                  o.extendTemplate({ attributes: { class: 'ck-alignment-dropdown' } });
                const s = 'rtl' === t.contentLanguageDirection ? gb : mb;
                return (
        ...
        class Ab extends Dl {
          constructor(
            t,
            { colors: e, columns: n, removeButtonLabel: i, documentColorsLabel: o, documentColorsCount: r }
          ) {
            if (
              (super(t),
              (this.items = this.createCollection()),
              ...
              const t = bl.bind(this.documentColors, this.documentColors),
                e = new jl(this.locale);
              (e.text = o),
                e.extendTemplate({
          ...
          _createStaticColorsGrid() {
            const t = new vb(this.locale, { colorDefinitions: this.colorDefinitions, columns: this.columns });
            return t.delegate('execute').to(this), t;
          }

          _createDocumentColorsGrid() {
            const t = bl.bind(this.documentColors, this.documentColors),
              e = new vb(this.locale, { columns: this.columns });
            return (
        ...
        function Ib(t) {
          return (e, n) => n.createAttributeElement('span', { style: `${t}:${e}` }, { priority: 7 });
        }
          ...
          return 'object' == typeof t
            ...
            ? (function (t) {
                const e = t.replace(/"|'/g, '').split(','),
                  n = e[0],
                  i = e.map(Lb).join(', ');
                return { title: n, model: n, view: { name: 'span', styles: { 'font-family': i }, priority: 7 } };
              })(t)
            : void 0;
        }
        ...
        class jb extends Kl {
          ...
          init() {
            ...
            const e = Rb(t.config.get('fontFamily.options')).filter(t => t.model),
              n = Mb(Cb, e);
            t.conversion.attributeToElement(n), t.commands.add(Cb, new Ob(t));
          }
        }
        ...
        class zb extends Kl {
                ...
                Mf(
                  ...
                  (function (t, e) {
                    ...
                    for (const i of t) {
                      const t = {
                        type: 'button',
                        model: new kf({ commandName: Cb, commandParam: i.model, label: i.title, withText: !0 }),
                      };
          ...
          _getLocalizedOptions() {
            const t = this.editor,
              e = t.t;
            return Rb(t.config.get(Cb).options).map(t => ('Default' === t.title && (t.title = e('bf')), t));
          }
        }
          ...
          return isNaN(e)
            ...
            : (function (t) {
                return {
                  title: String(t),
                  model: t,
                  view: { name: 'span', styles: { 'font-size': `${t}px` }, priority: 7 },
                };
              })(e);
        }
        ...
        class Wb extends Kl {
          constructor(t) {
            super(t), t.config.define(Tb, { options: ['tiny', 'small', 'default', 'big', 'huge'] });
            const e = Ub(this.editor.config.get('fontSize.options')).filter(t => t.model),
              n = Mb(Tb, e);
            t.conversion.attributeToElement(n), t.commands.add(Tb, new Fb(t));
          }
        ...
        class $b extends Kl {
          init() {
            const t = this.editor,
              ...
              n = this._getLocalizedOptions(),
              i = t.commands.get(Tb);
            t.ui.componentFactory.add(Tb, o => {
              const r = Sf(o);
              return (
                Mf(
                  r,
          ...
          _getLocalizedOptions() {
            const t = this.editor,
              e = t.t,
              n = { Default: e('bf'), Tiny: e('bj'), Small: e('bk'), Big: e('bl'), Huge: e('bm') };
            return Ub(t.config.get(Tb).options).map(t => {
              const e = n[t.title];
          ...
          constructor(t) {
            super(t),
              ...
              t.conversion.for('upcast').elementToAttribute({
                ...
                model: { key: Pb, value: Eb('color') },
              }),
              t.conversion.for('downcast').attributeToElement({
                model: Pb,
                view: Ib('color'),
              }),
              t.commands.add(Pb, new Qb(t)),
              t.model.schema.extend('$text', { allowAttributes: Pb }),
              t.model.schema.setAttributeProperties(Pb, {
                isFormatting: !0,
                copyOnEnter: !0,
              });
          }
        ...
        class Jb extends Kl {
          ...
          init() {
            ...
            t.ui.componentFactory.add(this.componentName, i => {
              const s = Sf(i);
              return (
                (this.colorTableView = (function ({
                  ...
                  dropdownView: s,
                  colors: o.map(t => ({ label: t.label, color: t.model, options: { hasBorder: t.hasBorder } })),
                  columns: this.columns,
                  removeButtonLabel: e('bx'),
                  documentColorsLabel: 0 !== r ? e('by') : void 0,
        ...
        var Zb =
          '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M12.4 10.3L10 4.5l-2.4 5.8h4.8zm.5 1.2H7.1L5.7 15H4.2l5-12h1.6l5 12h-1.5L13 11.5zM16 18.5H4a1 1 0 0 1 0-2h12a1 1 0 0 1 0 2z"/></svg>\n';

        class Xb extends Jb {
          constructor(t) {
            const e = t.locale.t;
            super(t, { commandName: Pb, componentName: Pb, icon: Zb, dropdownLabel: e('bg') });
          }
          ...
          constructor(t) {
            super(t),
              ...
              t.conversion.for('upcast').elementToAttribute({
                ...
                model: { key: Sb, value: Eb('background-color') },
              }),
              t.conversion.for('downcast').attributeToElement({
                model: Sb,
                view: Ib('background-color'),
              }),
              t.commands.add(Sb, new ew(t)),
              t.model.schema.extend('$text', { allowAttributes: Sb }),
              t.model.schema.setAttributeProperties(Sb, {
                isFormatting: !0,
                copyOnEnter: !0,
              });
          }
        ...
        class ow extends Jb {
          constructor(t) {
            const e = t.locale.t;
            super(t, { commandName: Sb, componentName: Sb, icon: iw, dropdownLabel: e('bh') });
          }
        ...
        (sw.builtinPlugins = [
          ...
          class extends Kl {
            ...
            _addListAutoformats() {
              const t = this.editor.commands;
              t.get('bulletedList') && new su(this.editor, /^[*-]\s$/, 'bulletedList'),
                t.get('numberedList') && new su(this.editor, /^1[.|)]\s$/, 'numberedList');
            }
            ...
            _addBasicStylesAutoformats() {
              ...
              if (t.get('italic')) {
                ...
                new au(this.editor, /(?:^|[^*])(\*)([^*_]+)(\*)$/g, t),
                  new au(this.editor, /(?:^|[^_])(_)([^_]+)(_)$/g, t);
              }
              if (t.get('code')) {
            ...
            _addBlockQuoteAutoformats() {
              this.editor.commands.get('blockQuote') && new su(this.editor, /^>\s$/, 'blockQuote');
            }
          },
          class extends Kl {
            static get requires() {

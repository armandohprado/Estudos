import { isFunction, isNil, uniqBy } from 'lodash-es';
...
export function transformPercentInReal(valor: number, percentual: number): number {
  if (!valor || !percentual) {
    return 0;
  }
...
// TODO substituir essa funcao pela navegação relative quando essa issue for corrigida: https://github.com/angular/angular/issues/22763
